      ...
      <table className="w-full">
        ...
        <tbody>
          <tr className="border-b-1 border-gray-200">
            ...
            <td>
              <div>
                ...
                <Label>
                  <InputRadio type="radio" name="category" value="cooking" />
                  <Text>요리</Text>
                </Label>
                <Label>
                  <InputRadio type="radio" name="category" value="alchemy" />
                  <Text>연금</Text>
                </Label>
                <Label>
                  <InputRadio type="radio" name="category" value="processing" />
                  <Text>가공</Text>
                </Label>
                <Label>
                  <InputRadio type="radio" name="category" value="weapon" />
                  <Text>무기</Text>
                </Label>
                <Label>
                  <InputRadio type="radio" name="category" value="armor" />
                  <Text>방어구</Text>
                </Label>
                <Label>
                  <InputRadio type="radio" name="category" value="accessory" />
                  <Text>악세사리</Text>
                </Label>
              </div>
            </td>
          ...
          <tr>
            ...
            <td>
              <Label>
                <InputRadio type="radio" name="favorite" value="favorite" />
                <Text>즐겨찾기</Text>
              </Label>
            </td>
          </tr>
...
const Text = tw.span`inline-flex items-center justify-center font-bold text-white bg-blue-500 h-7 px-3 rounded-14`;
