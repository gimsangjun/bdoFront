...
// TODO: 자동완성기능  처럼 한글자씩 입력해도 그 이름을 가진 아이템들 리턴.
export default function TableHeader({
  ...
  return (
    <div
      className="w-full bg-gray-200 bg-base-400 sticky top-32 z-50"
    ...
    >
      <div className="w-full flex flex-row bg-gray-400 p-2 rounded-lg ">
        ...
        <div className="relative flex items-center justify-center rounded-lg pr-2 bg-base-200 borde opacity-90 hover:opacity-100 h-[40px] py-0.5 pl-2 bg-white mr-2">
          <input
            autoComplete="off"
